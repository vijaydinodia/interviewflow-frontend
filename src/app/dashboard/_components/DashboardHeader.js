...
export default function DashboardHeader({ title, roleBadge }) {
  ...
  const handleSaveProfile = (e) => {
    ...
    const updated = { ...user, fullName: profileForm.fullName, email: profileForm.email, avatarUrl: profileForm.avatarUrl };
    setUser(updated);
    localStorage.setItem("interviewflow_session", JSON.stringify(updated));
